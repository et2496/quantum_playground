...
The Hamiltonian that is usually a matrix, encodes the size of the problem.
...
- An initial prediction of the ground state
- Variation of the state to improve the initial prediction
...
By repeating step 2 and 3, you learn about the landscape around your initial prediction and see if you approach lower energies. The lower the energy the closer your solution is to the ground state and to the ground state energy.

The amount of times the process has to be done, grows exponentially with the calculation of the expectation value which is computationally the most expensive step.
...
This quantum element and its results is then used in the classical variational approach and the state is varied to find information and at the end, the lowest energy and the ground state.
